  ...
  df %>%
    dplyr::mutate(
      term = dplyr::case_when(
        ...
        term == "pregn_during_WW1yes" ~ "Pregnancy overlapping World War I: yes vs no",
        term == "pregn_during_pandemicyes" ~ "Pregnancy overlapping influenza pandemic: yes vs no",
        term == "feeding_catbreastfeeding" ~ "Feeding mode: breastfeeding vs artificial feeding",
        term == "feeding_catmixed" ~ "Feeding mode: mixed feeding vs artificial feeding",
        term == "feeding_catother" ~ "Feeding mode: other vs artificial feeding",
        term == "ga_model" ~ "Gestational age, weeks",
        term == "sex_catmale" ~ "Male sex vs female",
        term == "parity" ~ "Parity",
        term == "age_mother" ~ "Maternal age, years",
        TRUE ~ term
      )
    )
}

table_MX_linear_period_GA_clean <- table_MX_linear_period_GA %>% clean_main_model_terms()
table_MX_logistic_period_GA_clean <- table_MX_logistic_period_GA %>% clean_main_model_terms()
...
export_existing_figure("figure_1_study_flowchart", "Figure_1_Study_Flowchart.png", file.path("outputs", "figures"), width = 7, height = 6)
export_existing_figure("figure_2_weightloss_distribution", "Figure_2_Weightloss_Distribution.png", file.path("outputs", "figures"), width = 7, height = 5)
export_existing_figure("figure_3_weightloss_by_feeding", "Figure_3_Weightloss_By_Feeding.png", file.path("outputs", "figures"), width = 7, height = 5)
export_existing_figure("figure_4_adjusted_forest", "Figure_4_Adjusted_Associations_Forestplot.png", file.path("outputs", "figures"), width = 10, height = 6)

export_existing_figure("appendix_figure_s1_subgroup_forest", "Supplementary_Figure_S1_Breastfeeding_Subgroups.png", file.path("outputs", "appendix_figures"), width = 12, height = 7)
export_existing_figure("appendix_figure_s2_historical_exposures", "Supplementary_Figure_S2_Historical_Exposures.png", file.path("outputs", "appendix_figures"), width = 14, height = 7.5)
export_existing_figure("appendix_figure_s3_sensitivity_forestplot", "Supplementary_Figure_S3_Sensitivity_Forestplot.png", file.path("outputs", "appendix_figures"), width = 14, height = 7.5)
export_existing_figure("appendix_figure_s4_excessive_weightloss", "Supplementary_Figure_S4_Excessive_Weightloss_By_Feeding.png", file.path("outputs", "appendix_figures"), width = 12, height = 7)
export_existing_figure("appendix_figure_s5_weightloss_by_year", "Supplementary_Figure_S5_Weightloss_By_Year.png", file.path("outputs", "appendix_figures"), width = 8, height = 5)
export_existing_figure("appendix_figure_s6_feeding_by_year", "Supplementary_Figure_S6_Feeding_By_Birthyear.png", file.path("outputs", "appendix_figures"), width = 8, height = 5)
