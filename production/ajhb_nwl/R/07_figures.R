...
ggsave(file.path("outputs", "figures", "Figure_1_Study_Flowchart.png"), figure_1_study_flowchart, width = 7, height = 6, dpi = 300)
...
ggsave(file.path("outputs", "figures", "Figure_2_Weightloss_Distribution.png"), figure_2_weightloss_distribution, width = 7, height = 5, dpi = 300)
...
figure_3_weightloss_by_feeding <- ggplot(
  ...
  geom_boxplot(width = 0.12, outlier.alpha = 0.15, outlier.size = 0.8) +
  labs(
...
ggsave(file.path("outputs", "figures", "Figure_3_Weightloss_By_Feeding.png"), figure_3_weightloss_by_feeding, width = 7, height = 5, dpi = 300)
...
ggsave(file.path("outputs", "figures", "Figure_4_Adjusted_Associations_Forestplot.png"), figure_4_adjusted_forest, width = 10, height = 6, dpi = 300)
...
appendix_figure_s1_subgroup_forest <- table_STR_logistic_excel_inputs %>%
  ...
  scale_x_continuous(breaks = seq(0, 2.5, by = 0.25), minor_breaks = seq(0, 2.5, by = 0.125)) +
  paper_forest_theme_s1()

export_figure(appendix_figure_s1_subgroup_forest, "Appendix_Figure_S1_Subgroup_Breastfeeding_Forestplot.png", file.path("outputs", "appendix_figures"), width = 12, height = 7)
...
export_figure(appendix_figure_s2_historical_exposures, "Appendix_Figure_S2_Historical_Exposures.png", file.path("outputs", "appendix_figures"), width = 14, height = 7.5)
...
export_figure(appendix_figure_s3_sensitivity_forestplot, "Appendix_Figure_S3_Sensitivity_Forestplot.png", file.path("outputs", "appendix_figures"), width = 14, height = 7.5)
...
export_figure(appendix_figure_s4_excessive_weightloss, "Appendix_Figure_S4_Excessive_Weightloss_By_Feeding.png", file.path("outputs", "appendix_figures"), width = 12, height = 7)
...
ggsave(file.path("outputs", "appendix_figures", "Appendix_Figure_S5_Weightloss_By_Year.png"), appendix_figure_s5_weightloss_by_year, width = 8, height = 5, dpi = 300)
...
ggsave(file.path("outputs", "appendix_figures", "Appendix_Figure_S6_Feeding_By_Birthyear.png"), appendix_figure_s6_feeding_by_year, width = 8, height = 5, dpi = 300)
